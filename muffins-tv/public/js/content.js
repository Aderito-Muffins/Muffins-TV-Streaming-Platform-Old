...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    function createCarouselItems(movies) {
        ...
        return movies.map(movie => {
            ...
            return `
                <div class="item" style="background: url('${movie.backdrop}'); background-size: cover; background-position: center;">
                            ...
                            <div class="row flex-row-reverse align-items-center h-100">
                                <div class="col-xl-6">
                                    <div class="gen-front-image">
                                        <img src="${movie.poster}" alt="imagem-banner-carrossel">
                                        ${movie.has_trailer ? `
                                ...
                                <div class="col-xl-6">
                                    <div class="gen-tag-line">
                                        <span>${movie.is_favorite ? 'Mais Visto' : 'Em Alta'}</span>
                                    </div>
                                    ...
                                    <div class="gen-movie-meta-holder">
                                        <ul class="gen-meta-after-title">
                                            <li class="gen-sen-rating"><span>${movie.lang}</span></li>
                                            <li class="gen-pulished-year"><span>${movie.year}</span></li>
                                            <li class="gen-rating"><span>${movie.type.name || 'N/A'}</span></li>
                                        </ul>
                                    </div>
            ...
            <div class="item">
                <div class="movie type-movie status-publish has-post-thumbnail hentry ">
                    <div class="gen-carousel-movies-style-2 movie-grid style-2">
                        <div class="gen-movie-contain">
                            <div class="gen-movie-img position-relative">
                                <img src="${post.backdrop}" alt="Movie Thumbnail" class="img-fluid">
                                ${post.age === "18+" ? `
                                    <div class="age-label position-absolute top-0 start-0 bg-danger text-white fw-bold p-1 rounded" style="margin: 10px;">
                                        +18
                                    </div>` : ''}
                                <div class="gen-movie-action">
                                    <a href="/episodes/single-episode.html?i=${post.post.id}&t=${post.post.type.slug}&s=${post.season.id}&ep=${post.id}" class="gen-button">
                                        <i class="fa fa-play"></i>
                                    </a>
                                </div>
                                        <div class="gen-info-contain">
                            <div class="gen-movie-info">
                                <h3><a href="#">${post.name} (${truncateText(post.post.name, 10)})</a></h3>
                            </div>
                            <div class="gen-movie-meta-holder">
                                <ul>
            ...
            contentContainer.innerHTML += `
                <section class="gen-section-padding-2">
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-6">
                                <h4 class="gen-heading-title">${section.title}</h4>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 d-none d-md-inline-block">
                                <div class="gen-movie-action text-right">
                                    <a href="/categories.html" class="gen-button gen-button-flat">
                            ...
                            <div class="col-12">
                                <div class="gen-style-2">
                                    <div class="owl-carousel owl-theme owl-anime-section" 
                                         ...
                                         data-mob_sm="1" data-autoplay="false" 
                                         data-loop="false" data-margin="30">
                                        ${createCarouselSectionsItem(section.items)}
                                    </div>
                                </div>
                            </div>
                        </div>
