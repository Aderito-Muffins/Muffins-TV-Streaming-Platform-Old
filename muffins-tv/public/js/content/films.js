const baseUrl = " https://app.muffinstv.com/muffins/v1/genre"; // Substitua pela URL real da sua API
...
let genre = getGenreFromURL() || 1; // Gênero inicial selecionado
...
async function loadFilms(page = 1, selectedGenre = genre) {
  ...
  try {
    ...
    if (data.code === 0) {
      ...
      updatePagination(data.pagination.pages, page); // Atualiza a paginação com total de páginas
    } else {
                            ...
                            <div class="gen-movie-action">
                                <a href="/${
                                  ["series", "animes", "dorama"].includes(
                                    ...
                                    ? "episodes"
                                    : "film"
                                }/single-episode.html?i=${film.id}&t=${
      film.type.slug
    }" class="gen-button">
