...
async function loadSeasonsAndEpisodes() {
    ...
    try {
        ...
        const activeAnimeId = new URLSearchParams(new URL(StrangeUrl).search).get('id');
...
function updateAnimeInfo(animeData) {
    const { title, rating, views, overview, genres, runtime, premiered, poster } = animeData.data;
                ...
                <div class="gen-carousel-movies-style-2 movie-grid style-2">
                    <div class="gen-movie-contain">
                        <div class="gen-movie-img position-relative">
                            <img src="${season.poster}" alt="${season.title}" class="img-fluid">
                            <div class="gen-movie-action">
                                <a href="/single-episode.html?animeId=${season.id}" class="gen-button">
