               ...
               <div class="row no-gutters">
                  <div class="col-12">
                     <div class="gen-banner-movies banner-style-2">
                        ...
                        <div class="item" style="background: url('${featured.poster}'); background-size: cover; background-position: center;">
                                ...
                                <div class="row flex-row-reverse align-items-center h-100">
                                    <div class="col-xl-6">
                                        <div class="gen-front-anime-image">
                                            <img src="${featured.poster}" alt="imagem-banner-carrossel">
                                    ...
                                    <div class="col-xl-6">
                                        <div class="gen-tag-line"><span>${featured.is_favorite ? 'Mais Visto' : 'Em Alta'}</span></div>
                                        <div class="gen-movie-info">
                                            <h3>${featured.title}</h3>
                                        </div>
                                        <div class="gen-movie-meta-holder">
                                            <ul class="gen-meta-after-title">
                                                <li class="gen-sen-rating"><span>${featured.age}</span></li>
                                                <li class="gen-pulished-year"><span>Premiado: ${featured.premiered}<span></li>
                                                <li class="gen-rating"><span> ${featured.rating || 'N/A'}</span></li>
                                            </ul>
                                            <div class="gen-meta-info">
                                                <ul class="gen-meta-after-excerpt">
                                                    <li><strong>Gênero :</strong> ${featured.genres}</li>
                                                    <li><strong>Duracao :</strong> ${featured.runtime}</li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="gen-movie-action">
                                            <div class="gen-btn-container">
                                                <a href="/single-movie.html?id=${featured.id}" class="gen-button gen-button-dark">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <h4 class="gen-heading-title">${section.name}</h4>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="gen-style-2">
                                        <div class="owl-carousel owl-theme owl-anime-section" 
                                            ...
                                            ${createCarouselItems(section.posts)}
                                        </div>
                                    </div>
                                </div>
                            </div>
